...
WITH LineitemView (l_orderkey, l_linenumber, l_extendedprice, l_discount, l_shipdate, l_quantity) AS 
        (Select l_orderkey, l_linenumber, l_extendedprice, l_discount, l_shipdate, l_quantity
        From Lineitem 
