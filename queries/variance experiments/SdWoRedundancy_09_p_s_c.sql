...
D1 (p_partkey, s_suppkey, amount) AS 
        (Select p_partkey, s_suppkey, SUM((l_extendedprice * ( 1 - l_discount)) - ps_supplycost * l_quantity) / probability_cust as amount 
...
From (Select p_partkey, SUM(amount / probability_supp) as cluster_estimate, 
