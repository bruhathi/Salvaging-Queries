...
D1 (c_custkey, p_partkey, amount) AS 
        (Select c_custkey, p_partkey, SUM((l_extendedprice * ( 1 - l_discount)) - ps_supplycost * l_quantity) / probability_supp as amount 
        From CustView, SuppView, PartView, Orders, Partsupp, Lineitem, Nation 
...
From (Select c_custkey, SUM(amount / probability_part) as cluster_estimate, 
