...
D1 (s_suppkey, c_custkey, amount) AS 
        (Select s_suppkey, c_custkey, SUM((l_extendedprice * ( 1 - l_discount)) - ps_supplycost * l_quantity) / probability_part as amount 
...
From (Select s_suppkey, SUM(amount / probability_cust) as cluster_estimate, 
